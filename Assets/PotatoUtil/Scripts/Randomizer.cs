 ...
 *
 * Copyright 2022 Terra Lauterbach <potatointeractive@gmail.com>
...
namespace PotatoUtil {
	...
	public class Randomizer {
		#region Protected internal state
		/// <summary>
		...
		public Randomizer(ulong initState, ulong initSeq) {
			Seed(initState, initSeq);
		}

		/// <summary>
		/// Initializes a new instance of <see cref="Randomizer"/> class
		/// using a <see cref="DateTime"/> as the seed.
		/// </summary>
		/// <param name="seedTime">Seed DateTime to use</param>
		...
		/// <summary>
		/// Returns a <see cref="System.String"/> that represents the current <see cref="Randomizer"/>.
		/// </summary>
		/// <returns>A <see cref="System.String"/> that represents the current <see cref="Randomizer"/>.</returns>
