...
## [3.4.0] - 2022-12-29
### Added
- `TryGet` function to `Database` structure

## [3.3.0] - 2022-11-04
### Added
- `ReadOnlyDatabase` that can be created based on a `Database`
- `AsReadOnly` function on `Database`

## [3.2.0] - 2022-10-29
### Added
- `FNVHash` can now be created from a `StringBuilder`
- `HashLookup` is inactive by default

## [3.1.2] - 2022-05-19
### Fixed
- `NullReferenceException`s in `Messenger` 

## [3.1.1] - 2022-05-19
### Fixed
- `Messenger` now queues new messages while invoking, preventing a list modification error

## [3.1.0] - 2022-05-16
### Changed
- `Database` now requires both a key and value type, operates more like a dictionary

## [3.0.3] - 2022-05-11
### Fixed
- version bump to fix package build

## [3.0.2] - 2022-05-11
### Fixed
- removed usage of `PotatoSerializer` and `PcgRandom` in `PotatoUtil` assembly definition

## [3.0.1] - 2022-05-11
### Removed
- dependency to `PotatoSerializer` package
- dependency to `PcgRandom` package
...
## [2.8.3] - 2022-04-26
### Added
- `IService` now requires a `Type` key property
### Fixed
- issue where `ServiceCache` would not recognized properly registered `IService`s

## [2.8.2] - 2022-04-26
### Added
- windowed `Get<T>` function in `ServiceCache` for simplified null check behaviour
